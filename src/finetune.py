...
from dataset import RealDataset, HalfHalfDataset
...
def parse_args():
    ...
    parser.add_argument('--syn-path', type=str, default='../synthetic')
    ...
    parser.add_argument('--split', type=str, default='bgext', choices=['bg', 'bgext'])
    ...
    parser.add_argument('--n-epochs', type=int, default=56)
